...
class vdeh_main_window(QMainWindow):
    def __init__(self, ui, model, loader):
        ...
        self.menu_Load_VevoLab_File_s.triggered.connect(self.action_load_vevolab_files)
        ...
        # )
        self.pushButton_set_output_path.clicked.connect(self.action_set_output_path)
        self.menu_Set_Output_Path.triggered.connect(self.action_set_output_path)
        self.pushButton_clear_output_path.clicked.connect(self.action_clear_output_path)
        self.pushButton_reset_form.clicked.connect(self.action_reset_form)
        self.menu_Reset.triggered.connect(self.action_reset_form)
        ...
        self.pushButton_extract_data.clicked.connect(self.action_extract_data_and_save)
        ...
        self.menu_User_Manual.triggered.connect(self.action_user_manual)
        self.menu_About.triggered.connect(self.action_about)
    ...
    def action_clear_vevolab_files(self):
        ...
        self.listWidget_vevolab_files.clear()
        self.pushButton_clear_vevolab_files.setHidden(True)
        self.logger.log("info", "VevoLab Report files cleared")
    ...
    def action_clear_metadata_settings_file(self):
        ...
        # settings
        self.model.animal_data = pandas.DataFrame()
        ...
        self.logger.log("info", "Metadata/Settings file cleared")
    ...
    def action_set_output_path(self):
        ...
        self.logger.log("info", f"Output location set: {self.model.output_path}")
    ...
    def action_about(self):
        QMessageBox.information(
            None,
            "About VDEH",
            "\n".join([f"{k} : {v}" for k, v in self.model.version_info.items()]),
        )
